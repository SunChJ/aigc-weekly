/* eslint-disable */
// Generated by Wrangler by running `wrangler types --cwd worker --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 750274630a42aa86c700c336edb27a9f)
// Runtime types generated with workerd@1.20251125.0 2025-11-29 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		AGENT_CONTAINER: DurableObjectNamespace<import("./index").AgentContainer>;
		CHAT_WORKFLOW: Workflow<Parameters<import("./index").ChatWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_BASE_URL" | "ANTHROPIC_AUTH_TOKEN" | "ANTHROPIC_DEFAULT_SONNET_MODEL" | "ANTHROPIC_DEFAULT_HAIKU_MODEL" | "DISABLE_AUTOUPDATER" | "DISABLE_NON_ESSENTIAL_MODEL_CALLS" | "CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC" | "EXA_API_KEY" | "FIRECRAWL_API_KEY" | "GOPHER_API_KEY">> {}
}
